# Add Note
- will have one more button to add notes for students. 
- note will be added by user name and time stamp and note contents
- will show popup note winddow to add note
- after saving note will showed in view as each record, also provide to edit /delete 
